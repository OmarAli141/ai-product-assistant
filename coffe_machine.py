...
# CrewAI uses LangChain's Google integration
llm = LLM(
...
# Agent 1: Coffee Machine Operator
...
# Agent 2: Search Engine Operator
...
# Agent 3: Scrape Engine Operator
...
# Agent 4: Procurement Report Agent
